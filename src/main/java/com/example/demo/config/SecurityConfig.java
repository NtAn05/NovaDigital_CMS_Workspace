    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    // Replace with your exact frontend URL (e.g., http://127.0.0.1:5500 or
                    // http://localhost:3000)
                    corsConfiguration
                            .setAllowedOrigins(java.util.List.of("http://127.0.0.1:5500", "http://localhost:3000"));
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index.html", "/about.html", "/services.html", "/portfolio.html",
                                "/contact.html", "/feedback.html", "/login.html", "/register.html", "/member.html",
                                "/member-contact.html", "/admin.html", "/admin-messages.html", "/forgot-password.html",
                                "/inbox.html", "/user-profile.html",
                                "/pm-dashboard.html", "/client-dashboard.html", "/booking.html", "/rented-project.html",
                                "/member-profile.html",
                        ...
                        // In-app notifications: any authenticated user (scoped to current user in
                        // controller)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/projects/*/milestones/*/logs")
                        ...
                        .requestMatchers("/api/projects/*/assignments", "/api/projects/*/assignments/**")
                        .hasAnyRole("ADMIN", "RESOURCE")
                        .requestMatchers("/api/projects/*/clients", "/api/projects/*/clients/**")
                        .hasAnyRole("ADMIN", "RESOURCE")
